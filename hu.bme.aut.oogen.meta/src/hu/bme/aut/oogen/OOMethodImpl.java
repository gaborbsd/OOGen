 ...
 * </p>
 * <ul>
 * <li>{@link hu.bme.aut.oogen.OOMethodImpl#getParameters
 * <em>Parameters</em>}</li>
 * <li>{@link hu.bme.aut.oogen.OOMethodImpl#getReturnType <em>Return
 * Type</em>}</li>
 * <li>{@link hu.bme.aut.oogen.OOMethodImpl#getStatements
 * <em>Statements</em>}</li>
 * <li>{@link hu.bme.aut.oogen.OOMethodImpl#getVisibility
 * <em>Visibility</em>}</li>
 ...
 * <li>{@link hu.bme.aut.oogen.OOMethodImpl#getLanguages
 * <em>Languages</em>}</li>
 * </ul>
 *
 * @generated
...
public class OOMethodImpl extends MinimalEObjectImpl.Container implements OOMethod {
	...
	if (parameters == null) {
	    parameters = new EObjectContainmentEList<OOVariable>(OOVariable.class, this,
		    OogenPackage.OO_METHOD__PARAMETERS);
	}
	return parameters;
    }
	...
	if (eNotificationRequired()) {
	    ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
		    OogenPackage.OO_METHOD__RETURN_TYPE, oldReturnType, newReturnType);
	    if (msgs == null)
		msgs = notification;
	    else
	...
	if (newReturnType != returnType) {
		...
		msgs = ((InternalEObject) returnType).eInverseRemove(this,
			EOPPOSITE_FEATURE_BASE - OogenPackage.OO_METHOD__RETURN_TYPE, null, msgs);
	    ...
	    eNotify(new ENotificationImpl(this, Notification.SET, OogenPackage.OO_METHOD__RETURN_TYPE, newReturnType,
		    newReturnType));
    }
	...
	if (statements == null) {
	    statements = new EObjectContainmentEList<OOStatement>(OOStatement.class, this,
		    OogenPackage.OO_METHOD__STATEMENTS);
	}
	return statements;
    }
	...
	if (eNotificationRequired())
	    eNotify(new ENotificationImpl(this, Notification.SET, OogenPackage.OO_METHOD__VISIBILITY, oldVisibility,
		    visibility));
    }
	...
	if (!(o instanceof OOMethod)) {
	    return false;
	}
	
	OOMethod other = (OOMethod) o;
	if (other.getName().toUpperCase().equals(this.getName().toUpperCase())) {
	    return true;
	}
