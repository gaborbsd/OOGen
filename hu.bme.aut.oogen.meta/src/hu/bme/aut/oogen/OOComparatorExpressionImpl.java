...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>OO Comparator Expression</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link hu.bme.aut.oogen.OOComparatorExpressionImpl#getLeftSide <em>Left Side</em>}</li>
 *   <li>{@link hu.bme.aut.oogen.OOComparatorExpressionImpl#getRightSide <em>Right Side</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OOComparatorExpressionImpl extends OOLogicalExpressionImpl implements OOComparatorExpression {
        /**
         ...
         * @generated
         */
        protected OOComparatorExpressionImpl() {
                super();
        }
        ...
        protected EClass eStaticClass() {
                return OogenPackage.Literals.OO_COMPARATOR_EXPRESSION;
        }
                ...
                if (leftSide != null && leftSide.eIsProxy()) {
                        ...
                        if (leftSide != oldLeftSide) {
                                if (eNotificationRequired())
                                        eNotify(new ENotificationImpl(this, Notification.RESOLVE, OogenPackage.OO_COMPARATOR_EXPRESSION__LEFT_SIDE, oldLeftSide, leftSide));
                        }
                }
                return leftSide;
        }
        ...
        public void setLeftSide(OOExpression newLeftSide) {
                ...
                if (eNotificationRequired())
                        eNotify(new ENotificationImpl(this, Notification.SET, OogenPackage.OO_COMPARATOR_EXPRESSION__LEFT_SIDE, oldLeftSide, leftSide));
        }
        ...
        public OOExpression getRightSide() {
                if (rightSide != null && rightSide.eIsProxy()) {
                        ...
                        if (rightSide != oldRightSide) {
                                if (eNotificationRequired())
                                        eNotify(new ENotificationImpl(this, Notification.RESOLVE, OogenPackage.OO_COMPARATOR_EXPRESSION__RIGHT_SIDE, oldRightSide, rightSide));
                        }
                }
                return rightSide;
        }
        ...
        public void setRightSide(OOExpression newRightSide) {
                ...
                if (eNotificationRequired())
                        eNotify(new ENotificationImpl(this, Notification.SET, OogenPackage.OO_COMPARATOR_EXPRESSION__RIGHT_SIDE, oldRightSide, rightSide));
        }
        ...
        public Object eGet(int featureID, boolean resolve, boolean coreType) {
                switch (featureID) {
                        case OogenPackage.OO_COMPARATOR_EXPRESSION__LEFT_SIDE:
                                if (resolve) return getLeftSide();
                                return basicGetLeftSide();
                        case OogenPackage.OO_COMPARATOR_EXPRESSION__RIGHT_SIDE:
