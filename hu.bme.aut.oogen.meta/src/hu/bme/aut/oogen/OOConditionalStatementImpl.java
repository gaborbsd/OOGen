...
public class OOConditionalStatementImpl extends OOStatementImpl implements OOConditionalStatement {
         ...
         * @generated
         */
        public NotificationChain basicSetCondition(OOExpression newCondition, NotificationChain msgs) {
        ...
        public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
                if (baseClass == OOCompoundStatement.class) {
                        switch (derivedFeatureID) {
                                case OogenPackage.OO_CONDITIONAL_STATEMENT__BODY_STATEMENTS: return OogenPackage.OO_COMPOUND_STATEMENT__BODY_STATEMENTS;
                                default: return -1;
                        }
                }
        ...
        public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
                if (baseClass == OOCompoundStatement.class) {
                        switch (baseFeatureID) {
                                case OogenPackage.OO_COMPOUND_STATEMENT__BODY_STATEMENTS: return OogenPackage.OO_CONDITIONAL_STATEMENT__BODY_STATEMENTS;
                                default: return -1;
                        }
                }
